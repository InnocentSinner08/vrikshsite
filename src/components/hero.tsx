    ...
    >
      <SwiperSlide>
        <div className="w-full h-[calc(100vh-12vh)] relative">
          <Image src="/1_top.jpg" alt="hero" fill objectFit="cover"></Image>
      ...
      <SwiperSlide>
        <div className="w-full h-[calc(100vh-12vh)] relative">
          <Image src="/2_top.jpg" alt="hero" fill objectFit="cover"></Image>
          <div className="absolute bg-[#0000007a] w-full left-0 bottom-0 flex justify-center items-center text-md px-10 text-white text-center py-8">
      ...
      <SwiperSlide>
        <div className="w-full h-[calc(100vh-12vh)] relative">
          <Image src="/3_top.jpg" alt="hero" fill objectFit="cover"></Image>
          <div className="absolute bg-[#0000007a] w-full left-0 bottom-0 flex justify-center items-center text-md px-10 text-white text-center py-8">
      ...
      <SwiperSlide>
        <div className="w-full h-[calc(100vh-12vh)] relative">
          <Image src="/4_top.jpg" alt="hero" fill objectFit="cover"></Image>
          <div className="absolute bg-[#0000007a] w-full left-0 bottom-0 flex justify-center items-center text-md px-10 text-white text-center py-8">
