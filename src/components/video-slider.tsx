  ...
  const slides = [
    {
      ...
      content: `A heartfelt message from the mother of Kashish Kumari, expressing her gratitude for the invaluable support and guidance her daughter has received. She highlights how Vriksh has played a pivotal role in improving Kashish’s studies, providing both educational and emotional assistance. The message is a testament to the positive impact the organization has had on her academic journey.`,
    },
    {
      ...
      {slides.map((slide, index) => (
        <SwiperSlide key={index}>
          <div className="w-full h-[calc(100vh-12vh)] flex flex-col items-center justify-center md:flex-row gap-6 px-8 py-6">
            ...
            <div className="text-justify max-w-[85%] md:max-w-[40%] text-sm md:text-lg">
              {slide.content}
            </div>
          </div>
        </SwiperSlide>
