...
const partners = [
  {
    id: 1,
    name: "JEEVIKA",
    imageUrl: "/images/ourpartner/jeevika_logo.png",
  ...
  },
  {
    id: 3,
    name: "NSS",
    imageUrl: "/images/ourpartner/NSS_Logo.png",
  ...
  },
  {
    id: 4,
    name: "SBI",
    imageUrl: "/images/ourpartner/SBI_logo.png",
          ...
          >
            ...
            <div className="flex-1">
              <h2 className="text-xl font-semibold mb-2">
                {partner.name === "Concept N Solution" ? (
                  <a
                    href={partner.link}
                    target="_blank"
              ...
              <p
                className={`text-gray-700 ${
                  expandedId === partner.id ? "line-clamp-none" : "line-clamp-2"
                }`}
                dangerouslySetInnerHTML={{
                  __html: expandedId === partner.id ? partner.description : partner.description.split('<br />').slice(0, 2).join('<br />'),
                }}
              />
              {partner.description.split('<br />').length > 2 && (
                <button
