    ...
    >
      <SwiperSlide>
        <div className="w-full h-[calc(100vh-12vh)] relative">
          <Image src="/images/homepage/slider1.jpg" alt="hero" fill objectFit="cover"></Image>
      ...
      <SwiperSlide>
        <div className="w-full h-[calc(100vh-12vh)] relative">
          <Image src="/images/homepage/slider2.JPG" alt="hero" fill objectFit="cover"></Image>
          <div className="absolute bg-[#0000007a] w-full left-0 bottom-0 flex flex-col justify-center items-center text-md px-10 text-white text-center py-8">
      ...
      <SwiperSlide>
        <div className="w-full h-[calc(100vh-12vh)] relative">
          <Image src="/images/homepage/slider3.JPG" alt="hero" fill objectFit="cover"></Image>
          <div className="absolute bg-[#0000007a] w-full left-0 bottom-0 flex flex-col justify-center items-center text-md px-10 text-white text-center py-8">
      ...
      <SwiperSlide>
        <div className="w-full h-[calc(100vh-12vh)] relative">
          <Image src="/images/homepage/slider4.JPG" alt="hero" fill objectFit="cover"></Image>
          <div className="absolute bg-[#0000007a] w-full left-0 bottom-0 flex flex-col justify-center items-center text-md px-10 text-white text-center py-8">
